...
enum H3DOptionsList
{
	...
	*/
		...
		H3DOptionsList_MaxLogLevel = 1,
		H3DOptionsList_MaxNumMessages,
		H3DOptionsList_TrilinearFiltering,
		MaxAnisotropy,
		H3DOptionsList_TexCompression,
		H3DOptionsList_SRGBLinearization,
		H3DOptionsList_LoadTextures,
		H3DOptionsList_FastAnimation,
		H3DOptionsList_ShadowMapSize,
		H3DOptionsList_SampleCount,
		H3DOptionsList_WireframeMode,
		H3DOptionsList_DebugViewMode,
		H3DOptionsList_DumpFailedShaders,
		H3DOptionsList_GatherTimeStats
};
...
enum H3DStatsList
{
	...
	*/
		...
		H3DStatsList_TriCount = 100,
		H3DStatsList_BatchCount,
		H3DStatsList_LightPassCount,
		H3DStatsList_FrameTime,
		H3DStatsList_AnimationTime,
		H3DStatsList_GeoUpdateTime,
		H3DStatsList_ParticleSimTime,
		H3DStatsList_FwdLightsGPUTime,
		H3DStatsList_DefLightsGPUTime,
		H3DStatsList_ShadowsGPUTime,
		H3DStatsList_ParticleGPUTime,
		H3DStatsList_TextureVMem,
		H3DStatsList_GeometryVMem
};

enum H3DResTypesList
{
	/* Enum: H3DResTypes
	...
	*/
		H3DResTypesList_Undefined = 0,
		H3DResTypesList_SceneGraph,
		H3DResTypesList_Geometry,
		H3DResTypesList_Animation,
		H3DResTypesList_Material,
		H3DResTypesList_Code,
		H3DResTypesList_Shader,
		H3DResTypesList_Texture,
		H3DResTypesList_ParticleEffect,
		H3DResTypesList_Pipeline
};

enum H3DResFlagsList
{
	/* Enum: H3DResFlags
	...
	*/
		H3DResFlagsList_NoQuery = 1,
		H3DResFlagsList_NoTexCompression = 2,
		H3DResFlagsList_NoTexMipmaps = 4,
		H3DResFlagsList_TexCubemap = 8,
		H3DResFlagsList_TexDynamic = 16,
		H3DResFlagsList_TexRenderable = 32,
		H3DResFlagsList_TexSRGB = 64
};
...
enum H3DFormatsList
{
	...
	*/
		H3DFormatsList_Unknown = 0,
		H3DFormatsList_TEX_BGRA8,
		H3DFormatsList_TEX_DXT1,
		H3DFormatsList_TEX_DXT3,
		H3DFormatsList_TEX_DXT5,
		H3DFormatsList_TEX_RGBA16F,
		TEX_RGBA32F
};
...
enum H3DGeoResList
{
	...
	*/
		H3DGeoResList_GeometryElem = 200,
		H3DGeoResList_GeoIndexCountI,
		H3DGeoResList_GeoVertexCountI,
		H3DGeoResList_GeoIndices16I,
		H3DGeoResList_GeoIndexStream,
		H3DGeoResList_GeoVertPosStream,
		H3DGeoResList_GeoVertTanStream,
		H3DGeoResList_GeoVertStaticStream
};
...
enum H3DAnimResList
{
	...
	*/
		H3DAnimResList_EntityElem = 300,
		H3DAnimResList_EntFrameCountI
};
...
enum H3DMatResList
{
	...
	*/
		H3DMatResList_MaterialElem = 400,
		H3DMatResList_SamplerElem,
		H3DMatResList_UniformElem,
		H3DMatResList_MatClassStr,
		H3DMatResList_MatLinkI,
		H3DMatResList_MatShaderI,
		H3DMatResList_SampNameStr,
		H3DMatResList_SampTexResI,
		H3DMatResList_UnifNameStr,
		H3DMatResList_UnifValueF4
};

enum H3DShaderResList
{
	/* Enum: H3DShaderRes
	...
	*/
		H3DShaderResList_ContextElem = 600,
		H3DShaderResList_SamplerElem,
		H3DShaderResList_UniformElem,
		H3DShaderResList_ContNameStr,
		H3DShaderResList_SampNameStr,
		H3DShaderResList_UnifNameStr,
		H3DShaderResList_UnifSizeI,
		H3DShaderResList_UnifDefValueF4
};
...
enum H3DTexResList
{
	/* Enum: H3DTexRes
		...
		ImgPixelStream  - Pixel data of an image. The data layout matches the layout specified
		                  ...
		                  left corner.
	*/
		H3DTexResList_TextureElem = 700,
		H3DTexResList_ImageElem,
		H3DTexResList_TexFormatI,
		H3DTexResList_TexSliceCountI,
		H3DTexResList_ImgWidthI,
		H3DTexResList_ImgHeightI,
		H3DTexResList_ImgPixelStream
};

enum H3DPartEffResList
{
	/* Enum: H3DPartEffRes
	...
	*/
		H3DPartEffResList_ParticleElem = 800,
		H3DPartEffResList_ChanMoveVelElem,
		H3DPartEffResList_ChanRotVelElem,
		H3DPartEffResList_ChanSizeElem,
		H3DPartEffResList_ChanColRElem,
		H3DPartEffResList_ChanColGElem,
		H3DPartEffResList_ChanColBElem,
		H3DPartEffResList_ChanColAElem,
		H3DPartEffResList_PartLifeMinF,
		H3DPartEffResList_PartLifeMaxF,
		H3DPartEffResList_ChanStartMinF,
		H3DPartEffResList_ChanStartMaxF,
		H3DPartEffResList_ChanEndRateF,
		H3DPartEffResList_ChanDragElem
};
...
enum H3DPipeResList
{
	...
	*/
		H3DPipeResList_StageElem = 900,
		H3DPipeResList_StageNameStr,
		H3DPipeResList_StageActivationI
};


enum H3DNodeTypesList
{
	/*	Enum: H3DNodeTypes
	...
	*/
		H3DNodeTypesList_Undefined = 0,
		H3DNodeTypesList_Group,
		H3DNodeTypesList_Model,
		H3DNodeTypesList_Mesh,
		H3DNodeTypesList_Joint,
		H3DNodeTypesList_Light,
		H3DNodeTypesList_Camera,
		H3DNodeTypesList_Emitter
};

enum H3DNodeFlagsList
{
	/*	Enum: H3DNodeFlags
	...
	*/
		H3DNodeFlagsList_NoDraw = 1,
		H3DNodeFlagsList_NoCastShadow = 2,
		H3DNodeFlagsList_NoRayQuery = 4,
		H3DNodeFlagsList_Inactive = 7  // NoDraw | NoCastShadow | NoRayQuery
};

enum H3DNodeParamsList
{
	/*	Enum: H3DNodeParams
	...
	*/
		H3DNodeParamsList_NameStr = 1,
		H3DNodeParamsList_AttachmentStr
};
...
enum H3DModelList
{
	...
	*/
		H3DModelList_GeoResI = 200,
		H3DModelList_SWSkinningI,
		H3DModelList_LodDist1F,
		H3DModelList_LodDist2F,
		H3DModelList_LodDist3F,
		H3DModelList_LodDist4F
};
...
enum H3DMeshList
{
	...
	*/
		H3DMeshList_MatResI = 300,
		H3DMeshList_BatchStartI,
		H3DMeshList_BatchCountI,
		H3DMeshList_VertRStartI,
		H3DMeshList_VertREndI,
		H3DMeshList_LodLevelI
};
...
enum H3DLightList
{
	...
	*/
		H3DLightList_MatResI = 500,
		H3DLightList_RadiusF,
		H3DLightList_FovF,
		H3DLightList_ColorF3,
		H3DLightList_ColorMultiplierF,
		H3DLightList_ShadowMapCountI,
		H3DLightList_ShadowSplitLambdaF,
		H3DLightList_ShadowMapBiasF,
		H3DLightList_LightingContextStr,
		H3DLightList_ShadowContextStr
};
...
enum H3DCameraList
{
	...
	*/
		H3DCameraList_PipeResI = 600,
		H3DCameraList_OutTexResI,
		H3DCameraList_OutBufIndexI,
		H3DCameraList_LeftPlaneF,
		H3DCameraList_RightPlaneF,
		H3DCameraList_BottomPlaneF,
		H3DCameraList_TopPlaneF,
		H3DCameraList_NearPlaneF,
		H3DCameraList_FarPlaneF,
		H3DCameraList_ViewportXI,
		H3DCameraList_ViewportYI,
		H3DCameraList_ViewportWidthI,
		H3DCameraList_ViewportHeightI,
		H3DCameraList_OrthoI,
		H3DCameraList_OccCullingI
};
...
enum H3DEmitterList
{
	...
	*/
		H3DEmitterList_MatResI = 700,
		H3DEmitterList_PartEffResI,
		H3DEmitterList_MaxCountI,
		H3DEmitterList_RespawnCountI,
		H3DEmitterList_DelayF,
		H3DEmitterList_EmissionRateF,
		H3DEmitterList_SpreadAngleF,
		H3DEmitterList_ForceF3
};
...
*/
float h3dGetOption(enum H3DOptionsList );
...
*/
int h3dSetOption(enum H3DOptionsList, float value );
...
*/
float h3dGetStat(enum H3DStatsList , int reset );
